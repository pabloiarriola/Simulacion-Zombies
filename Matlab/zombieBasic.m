...
z0 = 1; %poblacion inicial de zombies
h0 = 10000; %poblacion inicial de  humanos
  

zSpeed = 7; %velocidad maxima del zombie
hSpeed = 4; %velocidad maxima del humano

hSightRadius = 10; %distancia maxima que un humano puede sentir a un zombie
zSightRadius = 60
%distancia maxima que un zombie puede sentir a un humano

hAttackRadius = 0; %distancia maxima de ataque de un humano
zAttackRadius = 10; %distancia maxima de ataque de un zombie

pz = 0.7; %probabilidad que un zombie convierta a un humano, taza de crecimiento - valor k 
ph = 0; %probabilidad de que un humano mate a un zombie
